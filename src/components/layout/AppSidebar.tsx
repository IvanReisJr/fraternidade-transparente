...
const navigation = [
  ...
  { name: "Novo Lançamento", href: "/novo-lancamento", icon: PlusCircle },
  { name: "Auditoria", href: "/auditoria", icon: ClipboardCheck },
    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-sidebar">
      <div className="flex h-full flex-col">
        ...
        <div className="border-t border-sidebar-border p-3">
          ...
          <NavLink
            to="/"
            className="nav-item mt-2 text-sidebar-foreground/60 hover:text-sidebar-foreground"
          >
